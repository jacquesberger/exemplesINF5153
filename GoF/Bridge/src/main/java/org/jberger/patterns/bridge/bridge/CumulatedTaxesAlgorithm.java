...
public class CumulatedTaxesAlgorithm implements TaxCalculatorImpl {
    private double provincialRate;
    private double federalRate;
    
    public CumulatedTaxesAlgorithm() {
        provincialRate = 0;
        federalRate = 0;
    }
    ...
    public TaxTotals getTotals(Currency subtotal) {
        ...
        Currency temp = subtotal.add(federal);
        Currency provincial = temp.applyPourcentage(provincialRate);
